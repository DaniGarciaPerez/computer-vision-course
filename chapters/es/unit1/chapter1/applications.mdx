...
En el mundo actual, los sistemas de visión artificial cada vez realizan tareas más difíciles, algunas de las cuales son difíciles de realizar hasta para los humanos. Vamos a poner como ejemplo India. Sabías que India tiene el mayor número de motoristas registrados en el mundo? Con este vasto número de conductores, algunos de ellos olvidan el uso de casco o de medidas de seguridad. Esta imprudencia tiene como consecuencia lesiones graves en accidentes. Para mitigar este hábito entre los motoristas, el gobierno de India,  en colaboración contras instituciones, desarrolló un sistema de visión artificial que automáticamente identifica la matrícula de aquellos motoristas que circulan sin casco. A dichos motoristas se les impone multas muy estrictas para disuadir al resto de de conductores del incumplimiento de leyes como esta.

Por supuesto, multar gente no es la única aplicación de los sistemas de Visión Artificial. Estos sistemas tiene usos muy variopintos en industrias como salud, retail y muchas otras. Aquí, damos unos cuantos ejemplos a alto nivel de sistemas de Visión Artificial.

## Una Descripción a Alto Nivel de Sistemas de Visión Artificial con Ejemplos

### Vehículos Autónomos

<div class="flex justify-center">
    <img src="https://huggingface.co/datasets/hf-vision/course-assets/resolve/743a2a115b53f258c9e6bc7744534d9e03b8a124/self_driving_gif.gif" alt="Ejemplo de tareas de Visión Artificial en un vehículo autónomo, fuente Andrej Karpathy">
</div>

Self-driving cars heavily rely on computer vision to perceive and interpret the environment. 
They use cameras and sensors to identify objects, pedestrians, traffic signs, lane markings, 
and other vehicles on the road. Based on the analyzed data, 
computer vision algorithms help these vehicles make real-time decisions, such as steering, 
accelerating, or braking. Companies like Tesla, Waymo, and Uber are actively working on this 
technology to make transportation safer and more efficient.
